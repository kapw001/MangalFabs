...
public class FullScreenWitSlideActivity extends AppCompatActivity {

    private static final String TAG = "FullScreenWitSlideActiv";
...
//        int w=((display.widthPixels*3)/100);
//        Log.e(TAG, "onCreate: w "+w );
//        productWidth.setTextSize(w);
...
//        };
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            final ImageView scaleImage = (ImageView) view.findViewById(R.id.scale_img);
...
//                Picasso.get().load(R.drawable.scale).resize(width, 80).into(scaleImage);
