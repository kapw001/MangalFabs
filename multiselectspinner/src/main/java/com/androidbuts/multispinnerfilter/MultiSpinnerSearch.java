...
//                spinnerBuffer.append(", ");
        ...
        if (items.size() > 0) {
            ...
            if (count > 1)
                spinnerBuffer.append(items.get(selectedPos).getName() + " (" + count + ")");
            else spinnerBuffer.append(items.get(selectedPos).getName());
        }
...
//                Log.i(TAG, " ITEMS : " + items.size());
        ...
        ad = builder.show();
//        ad.getWindow().setBackgroundDrawableResource(android.R.color.white);
//        ad.getWindow().setBackgroundDrawable(new ColorDrawable(Color.YELLOW));
...
//            final int backgroundColor = (position % 2 == 0) ? R.color.white : R.color.white;
            convertView.setBackgroundColor(ContextCompat.getColor(getContext(), R.color.blackalpha));
            holder.textView.setTextColor(getResources().getColor(R.color.list_even));
            final KeyPairBoolData data = arrayList.get(position);
//            changeColorCheckBox(holder.checkBox, Color.parseColor("#3f4168"));
            changeColorCheckBox(holder.checkBox, getResources().getColor(R.color.list_even));
...
//                    Log.i(TAG, "On Click Selected Item : " + data.getName() + " : " + data.isSelected());
            ...
            if (data.isSelected()) {
                ...
                changeColorCheckBox(holder.checkBox, Color.parseColor("#FFFFFF"));
...
//                            Log.i(TAG, "Filter : " + mOriginalValues.get(i).getName() + " -> " + mOriginalValues.get(i).isSelected());
    ...
    public static void changeColorCheckBox(CheckBox checkBox, @ColorInt int color) {
